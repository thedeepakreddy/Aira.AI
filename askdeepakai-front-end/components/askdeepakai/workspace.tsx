...
export default function Workspace({view='auto',initialScreen='home'}:{view?:View;initialScreen?:Screen}) {
 ...
 <aside className="desktop-intro"><button className="desktop-orb-button" onClick={startVoice} aria-label="Start a voice conversation with Aira"><img src="/assets/orb.jpg" alt=""/></button><span className="desktop-orb-caption">Meet Aira</span><h2>A thought away.</h2><p>Speak your next idea into life.</p><button className="desktop-voice-link" onClick={startVoice}><Mic/>Start a conversation<span aria-hidden="true">↗</span></button></aside>
 </div>:<>
 ...
 <div className={'orb-wrap '+(paused?'is-paused':'')}><img className="orb-video" src="/assets/orb.jpg" alt="Glowing orb"/><img className="orb-still" src="/assets/orb.jpg" alt="Glowing orb"/></div>
